<x-pos-layout>
    <div class="pb-5">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h2 class="fs-4 fw-bold text-body mb-0 ms-2">Invoice</h2>
        </div>
        ...
        <div class="card border-0 rounded-4 shadow-sm bg-body p-3 p-lg-5">
                ...
                <div class="col-12 col-md-8">
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="fw-bold text-body small mb-2">Customer Name</div>
                            <div class="border rounded-3 p-2 px-3 bg-body fw-bold">Hasith Jayantha</div>
                        </div>
                        
                        <!-- Invoice No -->
                        <div class="col-12 col-sm-6">
                            <div class="fw-bold text-body small mb-2">Invoice No</div>
                            <div class="border rounded-3 p-2 px-3 bg-body fw-bold">054</div>
                        </div>

                        <!-- Customer Phone Number -->
                        <div class="col-12 col-sm-6">
                            <div class="fw-bold text-body small mb-2">Customer Phone Number</div>
                            <div class="border rounded-3 p-2 px-3 bg-body fw-bold">077 332 5138</div>
                        </div>
            ...
            <div class="row g-5">
                ...
                <!-- Totals & Payment -->
                <div class="col-12 col-md-6 d-flex flex-column gap-3 fw-bold text-body">
            ...
            <div class="d-flex justify-content-end align-items-center gap-4 mt-5 pt-4 border-top">
                <a href="{{ route('invoice.create') }}" class="text-primary-custom fw-bold text-decoration-none border-bottom border-primary border-2 pb-1">Edit Invoice</a>
